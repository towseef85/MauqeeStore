...
namespace MStore.Application.CatalogBL.ProductWarehouseInventoryBL
{
    public class Edit
    {
        ...
        public class Handler : IRequestHandler<Command, Result<Unit>>
        {
            ...
            {
                var result = await _iProductWarehouseInventoryRepo.UpdateProductWarehouseInventory(request.ProductWarehouseInventory, cancellationToken);
                if (!result) return Result<Unit>.Failure("Unable to add ProductWarehouseInventory");
