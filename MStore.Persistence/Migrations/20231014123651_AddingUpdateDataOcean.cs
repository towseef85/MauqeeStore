...
{
    public partial class AddingUpdateDataOcean : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "ProductAvailabilityRanges",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    SubscriptionId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductAvailabilityRanges", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalWeight = table.Column<decimal>(type: "decimal(18,6)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ZipPostalCode = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PhoneNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsPercentCommission = table.Column<bool>(type: "bit", nullable: false),
                    CommissionPercent = table.Column<decimal>(type: "decimal(18,6)", nullable: false),
                    CommissionAmount = table.Column<decimal>(type: "decimal(18,6)", nullable: false),
                    OnlyForFirstOrder = table.Column<bool>(type: "bit", nullable: false),
                    AdminComment = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Affiliates_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaximumDiscountAmount = table.Column<decimal>(type: "decimal(18,6)", nullable: true),
                    StartDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    EndDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    RequiresCouponCode = table.Column<bool>(type: "bit", nullable: false),
                    CouponCode = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LNTimesPerCustomer = table.Column<int>(type: "int", nullable: false),
                    LNTimes = table.Column<int>(type: "int", nullable: false),
                    MaximumDiscountedQuantity = table.Column<int>(type: "int", nullable: true),
                    IsCODFree = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingStatusId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PaymentStatusId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    OrderSubtotalInclTax = table.Column<decimal>(type: "decimal(18,6)", nullable: false),
                    OrderSubtotalExclTax = table.Column<decimal>(type: "decimal(18,6)", nullable: false),
                    OrderSubTotalDiscountInclTax = table.Column<decimal>(type: "decimal(18,6)", nullable: false),
                    OrderSubTotalDiscountExclTax = table.Column<decimal>(type: "decimal(18,6)", nullable: false),
                    OrderShippingInclTax = table.Column<decimal>(type: "decimal(18,6)", nullable: false),
                    OrderShippingExclTax = table.Column<decimal>(type: "decimal(18,6)", nullable: false),
                    PaymentMethodAdditionalFeeInclTax = table.Column<decimal>(type: "decimal(18,6)", nullable: false),
                    PaymentMethodAdditionalFeeExclTax = table.Column<decimal>(type: "decimal(18,6)", nullable: false),
                    TaxCategoryId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DiscountId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    OrderNetTotal = table.Column<decimal>(type: "decimal(18,6)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxNumberOfDownloads = table.Column<int>(type: "int", nullable: true),
                    ...
                    TaxCategoryId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DeliveryDateId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ProductAvailabilityRangeId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeleteDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Deleted = table.Column<bool>(type: "bit", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UnitPriceInclTax = table.Column<decimal>(type: "decimal(18,6)", nullable: false),
                    UnitPriceExclTax = table.Column<decimal>(type: "decimal(18,6)", nullable: false),
                    PriceInclTax = table.Column<decimal>(type: "decimal(18,6)", nullable: false),
                    PriceExclTax = table.Column<decimal>(type: "decimal(18,6)", nullable: false),
                    DiscountAmountInclTax = table.Column<decimal>(type: "decimal(18,6)", nullable: false),
                    DiscountAmountExclTax = table.Column<decimal>(type: "decimal(18,6)", nullable: false),
                    OriginalProductCost = table.Column<decimal>(type: "decimal(18,6)", nullable: false),
                    ...
                    ItemWeight = table.Column<decimal>(type: "decimal(18,6)", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeleteDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Deleted = table.Column<bool>(type: "bit", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NotifyAdminForQuantityBelow = table.Column<int>(type: "int", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeleteDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Deleted = table.Column<bool>(type: "bit", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EngName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    OtherName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ProductAttributeCombinationId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeleteDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Deleted = table.Column<bool>(type: "bit", nullable: false)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductAttributes_ProductAttributeCombinations_ProductAttributeCombinationId",
                        column: x => x.ProductAttributeCombinationId,
                        principalTable: "ProductAttributeCombinations",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductAttributes_ProductAttributeCombinationId",
